...
class IdentityUpResNet(nn.Module):
   def __init__(self, in_channels, intermediate_channels, expansion=4, identity_upsample=None, identity_downsample=None, stride=1):
      super().__init__()
